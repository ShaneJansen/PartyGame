 ...
 */
public class BackgroundController extends InputAdapter implements SjjController {
    ...
    public void update(float deltaTime) {
        ...
        //MyGdxGame.SPRITE_BATCH.draw(mBackground, -mBackground.getWidth() * 0.5f, -mBackground.getHeight() * 0.5f);
